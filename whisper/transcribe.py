...
def transcribe(
    ...
    def add_segment(
            *, start: float, end: float, text_tokens: torch.Tensor, result: DecodingResult, audio_features: torch.Tensor
    ):
            ...
            if len(consecutive) > 0:  # if the output contains two consecutive timestamp tokens
                ...
                for current_slice in consecutive:
                    ...
                    add_segment(
                        ...
                        result=result,
                        audio_features=result.audio_features[int(start_timestamp_position):int(end_timestamp_position),
                                       :].cpu(),
                    )
                ...
                start_timestamp_position = timestamps[0].item() - tokenizer.timestamp_begin
                ...
                add_segment(
                    ...
                    text_tokens=tokens,
                    result=result,
                    audio_features=result.audio_features[int(start_timestamp_position):int(last_timestamp_position), :].cpu(),
                )
...
def cli():
    ...
    parser.add_argument("--model_dir", type=str, default=None,
                        help="the path to save model files; uses ~/.cache/whisper1 by default")
